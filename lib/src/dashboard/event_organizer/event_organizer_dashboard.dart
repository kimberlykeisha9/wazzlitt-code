...
class _EventOrganizerDashboardState extends State<EventOrganizerDashboard> with SingleTickerProviderStateMixin {
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: TabBarView(
                  controller: _eventController,
                  children: widget.events.map((data) => FutureBuilder<DocumentSnapshot>(
                        future: data.get(),
                          ...
                          if (snapshot.hasData) {
                            ...
                            return Column(
                              children: [
                                ...
                                Text(DateFormat('E, dd MMM yy').format(eventData['date'].toDate())),
                                const SizedBox(height: 20),
                                Card(
                                    elevation: 10,
                                    child: Padding(
                                              ...
                                              return GestureDetector(
                                                onTap: () {
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                          EditTicket(event: data, ticket: ticket,)));
                                                },
                                                child: Column(
