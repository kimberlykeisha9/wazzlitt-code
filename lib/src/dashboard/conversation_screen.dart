...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  late final Future<DocumentSnapshot> getChats;
  late final Future<DocumentSnapshot> Function(
      Future<DocumentSnapshot<Object?>>) getOwnerInfo;
  late final Future<DocumentSnapshot> Function(
      Future<DocumentSnapshot<Object?>>) getChatroomChats;
  late final Future<DocumentSnapshot> Function(
      Future<DocumentSnapshot<Object?>>) getSenderData;
  late final Future<Patrone> Function(Future<Patrone>) getPatroneInfo;

  @override
  void initState() {
    super.initState();
    getChats = widget.chats.get();
    getOwnerInfo = (val) {
      return val;
    };
    getChatroomChats = (val) {
      return val;
    };
    getSenderData = (val) {
      return val;
                          ...
                          if (snapshot.hasData) {
                            ...
                            return SafeArea(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return FutureBuilder<DocumentSnapshot>(
                                    future: getChatroomChats(
                                        chats[index].reference.get()),
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                              Scaffold(
                                                                  ...
                                                                  body: FutureBuilder<
                                                                          Patrone>(
                                                                      future: getPatroneInfo(Patrone().getPatroneInformation((message['senderID']
